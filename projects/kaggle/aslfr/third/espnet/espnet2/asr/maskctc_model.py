...
class MaskCTCModel(ESPnetASRModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ic(speech.shape, text.shape)
        # 1. Encoder
        encoder_out, encoder_out_lens = self.encode(speech, speech_lengths)
        ic(encoder_out.shape, encoder_out_lens.shape)
        ...
        if self.ctc_weight != 0.0:
            ic(encoder_out.shape, text.shape)
    ...
    def _calc_mlm_loss(
        ...
        ic(decoder_out.shape, ys_in_pad.shape, ys_out_pad.shape)
