...
#          \file   dice_loss.py
#        \author   chenghuige
#          \date   2023-03-11 06:51:57.251264
#   \Description https://raw.githubusercontent.com/ShannonAI/dice_loss_for_NLP/d437bb999185535df46fdb74d1f2f57161331b44/loss/dice_loss.py
# ==============================================================================
  ...
  def _multiple_class(self, input, target, logits_size, mask=None):
    ...
    if self.ohem_ratio > 0:
      ...
      for label_idx in range(logits_size):
        ...
        if keep_num > 0:
          neg_scores = torch.masked_select(flat_input,
                                           neg_example.view(-1, 1).bool()).view(
                                               -1, logits_size)
        ...
        loss_idx = self._compute_dice_loss(flat_input_idx.view(-1, 1),
